...
const API_URL = serverAPIURL+"/finance"; //const API_URL = `${import.meta.env.API_URL}/users`;
            ...
            if (resp[0]) {
              ...
              try {
                if (Datas.value.length !== users.length) {
                  ////console.log("_Update Detected...#statment@store",syncPeriod.value)
                  Datas.value = resp[1];
                  counter = 0;
                  ...
                  ////console.log("No_Update Detected...#statment@store",syncPeriod.value)
                  counter = counter + 1;
                  if (counter === 5) {
