...
function request(method) {
  return async (url, body = null, paramObj = {}) => {
    ...
    requestOptions.headers["SameSite"] = "None";
            ...
            if (resp[0]) {
              ...
              try {
                if (Datas.value.length !== users.length) {
                  ////console.log("_Update Detected...#product@store",syncPeriod.value)
                  Datas.value = resp[1];
                  counter = 0;
                  ...
                  ////console.log("No_Update Detected...#product@store",syncPeriod.value)
                  counter = counter + 1;
                  if (counter === 5) {
