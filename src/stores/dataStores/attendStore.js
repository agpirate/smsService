  ...
  return async (url, body = null, paramObj = {}) => {
    ...
    if (body) {
        ...
        if (tobeUpload) {
         ...
         //////console.log('store attendance post',body)
      //---------------------------
      try {
        ...
        //StoreDebug = "Store Showing BackEnd Debug :- ...#"+method
            ...
            if (resp[0]) {
              ...
              try {
                if (Datas.value.length !== users.length) {
                  ////////console.log("_Update Detected...#attend@store",syncPeriod.value)
                  Datas.value = resp[1];
                  counter = 0;
                  ...
                  ////////console.log("No_Update Detected...#attend@store",syncPeriod.value)
                  counter = counter + 1;
                  if (counter === 5) {
